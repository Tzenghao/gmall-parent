...
import com.dubbo.gmall.admin.ums.vo.UmsAdminLoginParam;
import com.dubbo.gmall.admin.ums.vo.UmsAdminParam;
import com.dubbo.gmall.admin.utils.JwtTokenUtil;
...
public class UmsAdminController {
    ...
    /**
     * 1)注册成功返回用户所有信息{code,message,data:{username,icon,email}}
    ...
    public Object getAdminInfo(HttpServletRequest request) {
        ...
        //查询用户的头像
        //getOne是mybatis-plus自动生成的，而且带了泛型。
        //dubbo没办法直接调用map中带泛型的service，mp自动生成的可能有兼容问题，最好不要远程调用
